...
// ─── Pricing variables — update these to change displayed prices site-wide ───
const PRICES = {
  basicWebsite: {
    setup: 500,
    monthly: 10,
      ...
      <div className="container mx-auto px-6">
          ...
          {mainTiers.map((tier) => (
            ...
            >
              ...
              <div className="p-8 pb-6 border-b border-gray-100">
                ...
                {/* Setup fee */}
                <div className="mb-3">
                  <span className="font-display text-5xl text-gray-900">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">One-time or à la carte options for specific needs</p>
          </div>
