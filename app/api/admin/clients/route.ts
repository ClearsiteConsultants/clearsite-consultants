...
export async function PUT(req: NextRequest) {
  try {
    ...
    const { id, plan, service_status, client_status, maintenance_fee_frequency } = body;
    ...
    const result = await sql`
      ...
      SET plan = CASE
          ...
          updated_at = NOW()
      WHERE id = ${id}
      RETURNING id, email, company_name, plan, service_status, client_status, maintenance_fee_frequency, first_name, last_name, phone, next_invoice_due
    `;
