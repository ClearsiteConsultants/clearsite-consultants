      ...
      <main className="min-h-screen bg-white">
        <div className="container mx-auto px-6 py-16 max-w-3xl">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              TO THE FULLEST EXTENT PERMITTED BY APPLICABLE LAW, CLEARSITE CONSULTANTS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING OUT OF OR RELATED TO YOUR USE OF THE PORTAL, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY TO YOU FOR ANY CLAIM ARISING FROM THESE TERMS OR YOUR USE OF THE PORTAL SHALL NOT EXCEED THE AMOUNT PAID BY YOU TO CLEARSITE CONSULTANTS IN THE THREE (3) MONTHS PRECEDING THE CLAIM.
            </p>
          </section>
